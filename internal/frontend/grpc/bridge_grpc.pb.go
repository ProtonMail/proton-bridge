...
type BridgeClient interface {
	...
	// rpc ReleaseNotesLink(google.protobuf.Empty) returns (google.protobuf.StringValue); // TODO Apparently cannot be polled for now, will be sent as update.
	DependencyLicensesLink(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*wrapperspb.StringValue, error)
	//  rpc LandingPageLink(google.protobuf.Empty) returns (google.protobuf.StringValue); // TODO Apparently cannot be polled for now, will be sent as update.
